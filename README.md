...
Сначала необходимо изменить исходный код проекта на C++ (Source.cpp). Нужно изменить defin'ы, отвечающие за пути к текстовым файлам ввода и вывода. Затем необходимо скомпилировать программу и создать файл size.txt, в котором нужно указать размер квадратной матрицы. Следующий шаг это запуск скомпилированного .exe файла, после окончания его работы появятся файлы вывода:
...
- "Matrices are equal" - это означает, что матрица полученная при помощи PP_LAB_1.exe совпала с умножением двух матриц через модуль Numpy;
